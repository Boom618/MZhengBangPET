 ...
 * 到货入库 （待办 详情）
 */
class MaterialTodoDetailAdapter(private val context: Context, layoutId: Int, datas: List<MaterialDetailsIn.ListBean>)
    : CommonAdapter<MaterialDetailsIn.ListBean>(context, layoutId, datas) {


    internal var listener = mContext as SaveEditListener

    override fun convert(holder: ViewHolder, info: MaterialDetailsIn.ListBean, position: Int) {
