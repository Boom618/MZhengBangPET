 ...
 * 到货入库 （待办 详情）
 *
 * 采用数据库 ObjectBox 存储数据，替换接口回调
 */
public class MaterialTodoDetailBoxAdapter extends CommonAdapter<MaterialDetailsIn.ListBean> {

    private Context context;


    public MaterialTodoDetailBoxAdapter(Context context, int layoutId, List datas) {
        super(context, layoutId, datas);
        this.context = context;
    }

    @Override
    protected void convert(ViewHolder holder, MaterialDetailsIn.ListBean info, final int position) {
