 ...
 * 原材料 已办 列表
 */
class MaterialDoneAdapter(context: Context, layoutId: Int, datas: List<MaterialDoneList.ListBean>)
    : CommonAdapter<MaterialDoneList.ListBean>(context, layoutId, datas) {

    override fun convert(holder: ViewHolder, listBean: MaterialDoneList.ListBean, position: Int) {
