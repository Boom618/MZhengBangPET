 ...
 * 发货出库 待办详情
 */
public class SendOutTodoDetailAdapter extends CommonAdapter<ProductTodoDetails.ListBean> {


    public SendOutTodoDetailAdapter(Context context, int layoutId, List<ProductTodoDetails.ListBean> datas) {
