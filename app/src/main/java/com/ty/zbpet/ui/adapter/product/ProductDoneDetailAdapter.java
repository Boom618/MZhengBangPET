 ...
 * 生产入库 已办详情
 */
public class ProductDoneDetailAdapter extends CommonAdapter<ProductDetails.ListBean> {


    public ProductDoneDetailAdapter(Context context, int layoutId, List<ProductDetails.ListBean> datas) {
