...
class BuyInTodoFragment : BaseFragment(), ProductUiListInterface<ProductTodoList.ListBean> {
    ...
    private var adapter: BuyInTodoListAdapter? = null
    ...
    override fun showProduct(list: List<ProductTodoList.ListBean>) {
        ...
        if (adapter == null) {
            ...
            adapter = BuyInTodoListAdapter(ResourceUtil.getContext(), R.layout.item_material_todo, list)
    ...
    companion object {
        ...
        fun newInstance(tag: String): BuyInTodoFragment {
