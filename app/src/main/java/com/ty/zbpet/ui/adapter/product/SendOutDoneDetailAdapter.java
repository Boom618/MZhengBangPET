 ...
 * 发货出库 已办详情
 */
public class SendOutDoneDetailAdapter extends CommonAdapter<ProductDetails.ListBean> {


    public SendOutDoneDetailAdapter(Context context, int layoutId, List<ProductDetails.ListBean> datas) {
    ...
    protected void convert(ViewHolder holder, ProductDetails.ListBean list, final int position) {
        holder.setText(R.id.tv_name, list.getGoodsName())
                ...
                .setText(R.id.tv_send_number, "应发数量：" + list.getOrderNumber())
