 ...
 * @author TY
 */
public class ProductTodoListAdapter extends CommonAdapter<ProductTodoList.ListBean> {


    public ProductTodoListAdapter(Context context, int layoutId, List<ProductTodoList.ListBean> datas) {
