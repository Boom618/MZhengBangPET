 ...
 * @author TY
 */
class SendOutDoneFragment : BaseFragment(), ProductUiObjInterface<ProductDoneList> {


    private val presenter = SendOutPresenter(this)

    private var adapter: SendOutDoneListAdapter? = null
    ...
    companion object {
        ...
        fun newInstance(tag: String): SendOutDoneFragment {
            val fragment = SendOutDoneFragment()
            val bundle = Bundle()
